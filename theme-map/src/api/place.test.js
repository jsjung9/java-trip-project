...
describe('kakaoToDto', () => {
  it('creates an independent DTO for every search result', () => {
    const first = kakaoToDto({ id: '1', place_name: '첫 장소', x: '127', y: '37', address_name: '서울', phone: '' });
    const second = kakaoToDto({ id: '2', place_name: '둘째 장소', x: '128', y: '36', address_name: '부산', phone: '' });
